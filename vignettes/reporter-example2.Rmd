---
title: "Full Program 2: Demographics"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Full Program 2: Demographics}
...
functions to create a demographics summary table.

This example highlights many capabilities of the 
[sassy](https://sassy.r-sassy.org) family of packages: logging, libnames,
formatting, a datastep, and reporting.  These packages were written as a 
system, and work together to make reporting and data preparation in R easier.
...
Next: [Full Program 3: Adverse Events](reporter-example3.html)
