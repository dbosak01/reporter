---
title: "Full Program 1: Listing"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Full Program 1: Listing}
...
[sassy](https://sassy.r-sassy.org) functions to create a listing.  

Notice that the data for this example is both wide and long.  The **reporter**
package handles both to break and wrap pages at the appropriate spot.
...
Next: [Full Program 2: Demographics](reporter-example2.html)
