...
The example below demonstrates intermingling of table and text content.  This
...
report with multiple tables, or provide textual analysis along with tabular
or graphic displays.
...
```
<img src="../man/images/e4.png"  alt="Text example image"/>
