---
title: "Example 9: RTF, PDF, and HTML"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Example 9: RTF, PDF, and HTML}
...
The **reporter** package supports four types of output: TXT, RTF, PDF, and HTML. 
The package produces TXT reports by default.  If you want to produce RTF, PDF, 
or HTML output, simply change the output type.  Below is the summary table
