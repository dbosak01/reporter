...
**A:** The **reporter** package currently supports TXT, RTF, PDF and HTML output
types.  DOCX and possibly PowerPoint will be added in 2022.
...
TXT reports, no fonts are supported.  For PDF reports, currently only
Courier is supported.  But Arial and Times will be supported in PDF in 2022.
The RTF and HTML output types support Courier, Arial, and Times New Roman.
