# rptr.o <img src="man/images/reporter.svg" align="right" height="138" />

<!-- badges: start -->

[![rptr.o version](https://www.r-pkg.org/badges/version/rptr.o)](https://cran.r-project.org/package=rptr.o)
[![rptr.o lifecycle](https://img.shields.io/badge/lifecycle-maturing-blue.svg)](https://cran.r-project.org/package=rptr.o)
[![rptr.o downloads](https://cranlogs.r-pkg.org/badges/grand-total/rptr.o)](https://cran.r-project.org/package=rptr.o)
[![Travis build status](https://travis-ci.com/dbosak01/rptr.o.svg?branch=master)](https://travis-ci.com/dbosak01/rptr.o)
<!-- badges: end -->

The **rptr.o** package creates regulatory-style, statistical reports. It was designed
...
The **rptr.o** package is distributed under a [Creative Commons non-commercial 
...
The **rptr.o** package contains the following key features:
...
Below are the functions available in the **rptr.o** package, and a brief
...
a regulatory-style listing using **rptr.o** and the mtcars sample data frame:
...
reporting packages support them.  **rptr.o** supports any number of spanning
...
The **rptr.o** package supports three types of output: TXT, RTF, and PDF. 
