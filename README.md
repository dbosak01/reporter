...
[![R-CMD-check](https://github.com/dbosak01/reporter/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/dbosak01/reporter/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
